 ...
 * remaining types carry Boot's registered error pages, cookie {@code SameSite} suppliers and the
 * servlet context's stop-phase lifecycle into the servlet bridge.
 */
