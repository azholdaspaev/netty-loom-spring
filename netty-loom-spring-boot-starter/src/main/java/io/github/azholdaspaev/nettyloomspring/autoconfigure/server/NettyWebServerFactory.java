...
public class NettyWebServerFactory extends AbstractConfigurableWebServerFactory
    ...
    public WebServer getWebServer(ServletContextInitializer... initializers) {
        ...
        // Built here rather than injected as a bean: Boot binds server.server-header onto this factory
        // only after the pipeline bean exists, so the header can join the pipeline no earlier than this.
        NettyServerChannelInitializer channelInitializer =
            new NettyServerChannelInitializer(serverPipeline(), connectionRegistry);
    ...
    private NettyPipelineDefinition serverPipeline() {
