...
# one file equal ignoring case. A bare A is an article only before a lowercase letter or a digit,
# so the A of an acronym such as ALPN is not one; An and The never open an acronym.
