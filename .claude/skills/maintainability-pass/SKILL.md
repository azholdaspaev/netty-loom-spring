...
description: Second-pass pull request review for maintainability and consistency — naming, method naming, magic constants, duplication, comment budget, scope, module boundaries. Use after a bug-focused review pass has finished.
---
