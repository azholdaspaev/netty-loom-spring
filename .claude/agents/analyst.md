...
## CRITICAL: What NOT to Include in PRD

PRD focuses on WHAT/WHY (business requirements), not HOW (technical implementation).

**The following belong in ARCHITECTURE.md, NOT in PRD.md:**
- Code snippets or examples
- Specific libraries, frameworks, or tools (e.g., "use React", "add Spring Boot")
- Dependency versions (e.g., "netty 4.1.x", "loom 21+")
- Configuration examples (e.g., YAML, JSON configs)
...
**If user mentions technical details in their request:**
- Extract the underlying business need
- Document the requirement without the technical specification
- Note that technical approach will be determined in /plan phase
...
5. **Present PRD draft to user for review and approval** (do NOT save files yet)
6. Incorporate any feedback from user, repeat step 5 if changes requested
7. Only after user approval: Save artifact and update workflow state to PRD_READY

**IMPORTANT:** Never save PRD.md or STATE.md until the user explicitly approves the PRD draft.
