...
The AIDD workflow separates business requirements from technical implementation:
...
- Specific libraries, frameworks, or dependency versions
- Configuration examples
- API endpoints, database schemas, or data models
- Technical approach or algorithms

PRD describes WHAT the user needs, not HOW to build it.
...
### Step 4: Present PRD for Review
Present the complete PRD draft to the user and ask for approval:
- Display the full PRD content in a clear format
- Ask explicitly: "Please review this PRD. Do you approve, or would you like changes?"
- Wait for user response before proceeding

**IMPORTANT:** Do NOT create any files until the user approves the PRD.

### Step 5: Handle Approval
**If user approves:**
- Proceed to Step 6 (Create PRD Document)

**If user requests changes:**
- Incorporate the feedback into the PRD
- Return to Step 4 (present updated PRD for review)
- Repeat until user approves

### Step 6: Create PRD Document
Only after user approval, save PRD to: `.artifacts/{date}-{feature-name}/PRD.md`
