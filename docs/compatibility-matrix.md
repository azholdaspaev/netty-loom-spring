...
| `Server` response header | `works` | Written when `server.server-header` is set, replacing any value the application set, as Tomcat does; see [docs/configuration.md](configuration.md#standard-server-properties-that-are-honoured) |
