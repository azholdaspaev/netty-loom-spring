...
| Body consumption by `getParameter` | `works` | Reading form parameters consumes the body, as on Tomcat. Bounded separately at 2 MiB, Tomcat's `maxPostSize` default; past that the request is answered `413` |
